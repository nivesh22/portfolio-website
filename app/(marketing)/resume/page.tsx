...
export const metadata: Metadata = {
  title: "Resume | Los Angeles Data Scientist",
  description:
    "Download the resume for Nivesh Elangovanraaj, a Los Angeles-based data science professional delivering AI, analytics, and forecasting value across the United States.",
  ...
  return (
    <Section>
      <SectionIntro
        ...
        lead="Snapshot of my Los Angeles data science career, open to onsite LA roles and remote opportunities anywhere in the United States."
      />
      <div className="glass rounded-xl p-6 grid gap-6">
        ...
        <div className="text-sm">
          <p>
            Los Angeles data scientist with 7 years of experience delivering $30M+ measurable impact across banking, tech, and healthcare. I lead AI & ML workflows from data
            engineering and model development through deployment, monitoring, and business integration for US organizations. Proficient in Python, SQL, R, PySpark, and CI/CD
            tooling. Experienced with LLMs, NLP, forecasting, and predictive modeling. Co-author of 6 peer-reviewed papers on healthcare analytics.
          </p>
        </div>
          ...
          <div className="grid gap-5">
            <div>
              ...
              <ul className="list-disc pl-5 mt-2 text-sm space-y-1">
                <li>Designed and deployed liquidity monitoring + forecasting pipelines (ARDL & ARIMA) with CI/CD and drift monitoring; contributed ~$27M NBI over 2 years.</li>
                ...
                <li>Led a team of 3 data scientists, partnering across domains to reduce tech debt and improve consistency through internal tooling.</li>
              </ul>
            </div>
            <div>
              <div className="flex items-baseline justify-between">
              ...
              <ul className="list-disc pl-5 mt-2 text-sm space-y-1">
                <li>Built gradient-boosting driver models and sensitivity analysis to link CX with operations metrics; improved NPS by 800 bps and generated ~$5M value.</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 mt-2 text-sm space-y-1">
                ...
                <li>Published peer-reviewed articles and presented posters at industry conferences (ISPOR, ICPE).</li>
                <li>Assisted COVID-19 vaccine trial analytics by estimating optimal participant sample sizes.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <ul className="text-sm space-y-2">
            <li>
              <span className="font-medium">UCLA Anderson School of Management</span> — M.S. in Business Analytics (MSBA), expected 2026
            </li>
            <li>
              <span className="font-medium">Anna University</span> — B.E. Electrical & Electronics Engineering, 2018
            </li>
          </ul>
        </section>
